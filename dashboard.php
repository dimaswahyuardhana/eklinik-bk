...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header is-small-screen">
    ...
    <div class="mdl-layout__drawer">
        <header><img src="images/logo.png" width="40px" alt="">Ardhana Hospital</header>
        <div class="scroll__wrapper" id="scroll__wrapper">
            <div class="scroller" id="scroller">
                <div class="scroll__container" id="scroll__container">
                    <nav class="mdl-navigation">
                        <a class="mdl-navigation__link mdl-navigation__link--current" href="dashboard.php">
                            <i class="material-icons" role="presentation">dashboard</i>
                            Dashboard
                        </a>
                        <a class="mdl-navigation__link" href="dashboard.php?page=dokter">
                            <i class="material-icons">developer_board</i>
                            Dokter
                        </a>
                        <a class="mdl-navigation__link" href="dashboard.php?page=poli">
                            <i class="material-icons" role="presentation">person</i>
                            Poli
                        </a>
                        <a class="mdl-navigation__link" href="dashboard.php?page=obat">
                            <i class="material-icons" role="presentation">map</i>
                            Obat
                        </a>
                        <a class="mdl-navigation__link" href="dashboard.php?page=registerUser">
                            <i class="material-icons">multiline_chart</i>
                            Add Admin
                        </a>
                        <a class="mdl-navigation__link" href="dashboard.php?page=pasienadmin">
                            <i class="material-icons">multiline_chart</i>
                            Pasien
                        </a>
